 ...
 * @author IUT2
 */
public class AjoutParticipants extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AjoutParticipants.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
