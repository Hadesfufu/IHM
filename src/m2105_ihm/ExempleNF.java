...
public class ExempleNF {
    ...
    public static void exempleUtilisationEnumerations() {
        ...
        /* 
         * Exemple avec les Style musicaux
         * Affiche l'indice de chaque élément de l'énumération
         */
        for(StyleMusical style : StyleMusical.values()) {
    ...
    public static Contact exempleCreationContact() {
        ...
        c.addStyle(StyleMusical.CLASSIQUE);
        c.addStyle(StyleMusical.RNB);
        c.addStyle(StyleMusical.COUNTRY);
        
        c.addHobby(Hobby.SPORT);
        c.addHobby(Hobby.LECTURE);
        
        c.setHobbyAutre("la F1");
    ...
    public static Contact exempleModifierContact(Contact c) {
        ...
        c.removeStyle(StyleMusical.RNB);
        c.addStyle(StyleMusical.BLUES);
    ...
    public static void exempleAfficherContact(Contact c) {
        ...
        System.out.println("date de naissance : " + c.getDateNaissance()[2] + "/" + c.getDateNaissance()[1] + "/" + c.getDateNaissance()[0]);
        ...
        /* Liste des gout musicaux */  
        for(StyleMusical s : c.getGoutsMusicaux()) {
     ...
     *             d'évènements
     */
    public static CarnetPlanning exempleCreerCarnetPlanning() {
        Contact contact;
        Evenement evenement;
         ...
         * complet du carnet
         */
        carnet = new CarnetPlanning("/Users/laurillau/");
        ...
        carnet.ajouterContactGroupe(groupe, contact);
        
        /*
         * Créer, ajouter un évènement au planning, et associer un participant
         */
        evenement = exempleCreerEvenement();
        carnet.ajouterEvenement(evenement);
        carnet.ajouterParticipantEvenement(evenement, contact);
     ...
     */
    public static void exempleAfficherCarnetPlanning(CarnetPlanning carnet) {
        
        /*
         * Afficher la liste des contacts, des groupes et des évènements
         */
        Contact [] listeContacts = carnet.listeContacts();
         ...
         */       
        Contact [] membres;
        GroupeContacts [] listeGroupes = carnet.listeGroupes();
        ...
        for(GroupeContacts g : listeGroupes) {
            ...
            membres = carnet.listerContactsGroupe(g);            
        ...
        Evenement [] listeEvenements = carnet.listeEvenements();
        ...
        for(Evenement e : listeEvenements) {
            ...
            participants = carnet.listerParticipantsEvenement(e);            
     ...
     */
    public static void exempleModifierCarnetPlanning(CarnetPlanning carnet,
            Contact contact, GroupeContacts groupe, Evenement evenement) {

        /* 
         * Retirer un contact d'un groupe 
         */
        carnet.retirerContactGroupe(groupe, contact);
        
        /* 
         * Retirer un participant d'un évènement
         */
        carnet.retirerParticipantEvenement(evenement, contact);
        
        /* 
         * Supprimer un contact du carnet
         */
        carnet.supprimerContact(contact);

        /* 
         * Supprimer un contact du carnet
         */
        carnet.supprimerGroupe(groupe);
        
        /* 
         * Supprimer un évènement du planning
         */
        carnet.retirerEvenement(evenement);
    }

    /*
     * Exemple 10 : Sauvergarder le contenu du carnet et planning dans le fichier
     *              base de données
     */
    public static void exempleSauvegarderCarnetPlanning(CarnetPlanning carnet) {
        carnet.updateDB();
    }
    ...
    public static void main(String [] args) {
         ...
         * Carnet et planning
         */
        carnet = exempleCreerCarnetPlanning();
        exempleAfficherCarnetPlanning(carnet);
        exempleSauvegarderCarnetPlanning(carnet);
        
        /*
         * Modification du carnet
         */
        exempleModifierCarnetPlanning(carnet, c, g, e);
    }
}
